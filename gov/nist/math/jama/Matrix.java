 ...
 * Matrix.java
 * 
 * This file is part of the JAMA library.
 * 
 ...
 * Original authors:
 * 
 * Joe Hicklin, Cleve Moler and Peter Webb -- from The MathWorks
 * 
 * Ronald F. Boisvert, Bruce Miller, Roldan Pozo and Karin Remington -- from NIST
 * 
...
public class Matrix implements Cloneable {
    ...
    public static Matrix read(BufferedReader input) throws java.io.IOException {
        ...
        v2.addElement(row); // Start storing rows instead of columns.
        while (tokenizer.nextToken() == StreamTokenizer.TT_WORD) {
            // While non-empty lines
            v2.addElement(row = new double[n]);
            int j = 0;
            do {
                if (j >= n)
                    throw new java.io.IOException("Row " + v2.size() + " is too long.");
                row[j++] = Double.valueOf(tokenizer.sval).doubleValue();
            } while (tokenizer.nextToken() == StreamTokenizer.TT_WORD);
            if (j < n)
                throw new java.io.IOException("Row " + v2.size() + " is too short.");
        }
