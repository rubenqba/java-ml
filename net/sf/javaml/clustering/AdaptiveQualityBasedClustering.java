...
public class AdaptiveQualityBasedClustering implements Clusterer {
    ...
    private class AQBCem {
         ...
         */
        // main algorithm
        private double em(Vector<Instance> dataset, Vector<Instance> cluster, Instance ck, double rk_prelim,
    ...
    public Dataset[] executeClustering(Dataset data) {
        ...
        while (iterator < maxIterMain && endSign != 0) {
            ...
            double pc = em.em(all, cluster, ck, rk_prelim, dimension, instanceLength, varianceEst);
            double pb = 1 - pc;
