...
public class VisualTestKMedoids extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame window = new JFrame("KMedoids test");
        window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        window.setContentPane(new VisualTestKMedoids());
        window.pack();
        window.setVisible(true);

    }

    public VisualTestKMedoids() {
        ...
        KMedoids km = new KMedoids(new EuclideanDistance(),4,100);
    ...
    class ClusterLabel extends JLabel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.setColor(color);
            Instance centroid = DatasetTools.getCentroid(data, new EuclideanDistance());
            Instance medoid = DatasetTools.getClosest(data, new EuclideanDistance(), centroid);
            ...
            g.fillRect((int) medoid.getValue(0) - 4, (int) medoid.getValue(1) - 4, 8, 8);
//            if (km != null) {
