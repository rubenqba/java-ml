...
public class VisualTestOPTICS extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame window = new JFrame("OPTICS test");
        window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        window.setContentPane(new VisualTestOPTICS());
        window.pack();
        window.setVisible(true);

    }

    public VisualTestOPTICS() {
