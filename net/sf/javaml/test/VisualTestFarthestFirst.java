...
public class VisualTestFarthestFirst extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        window.setContentPane(new VisualTestFarthestFirst());
        window.pack();
        window.setVisible(true);

    }

    public VisualTestFarthestFirst() {
        ...
        FarthestFirst km = new FarthestFirst(3,new EuclideanDistance());
