/**
 * VisualTestMCL.java, 28-feb-2007
 *
...
public class VisualTestMCL extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame window = new JFrame("MCL test");
        window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        window.setContentPane(new VisualTestMCL());
        window.pack();
    ...
    private JLabel createLabel(Dataset data, Color color, int width, int height, MCL km, Color[] colors, int i) {
