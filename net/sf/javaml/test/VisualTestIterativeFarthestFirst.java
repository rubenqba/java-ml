...
public class VisualTestIterativeFarthestFirst extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame window = new JFrame("FF test");
        window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        window.setContentPane(new VisualTestIterativeFarthestFirst());
        window.pack();
        window.setVisible(true);

    }

    public VisualTestIterativeFarthestFirst() {
        ...
        IterativeFarthestFirst km = new IterativeFarthestFirst(new EuclideanDistance(),new Tau(new EuclideanDistance()),2,6);
