...
public class VisualTestVariableDataset extends JPanel {
	...
	public VisualTestVariableDataset() throws Exception {
		...
		//Dataset data = DatasetLoader.loadDataset(new File("clustersize25.data"));
		this.add(createLabel(data, Color.BLACK, space, space, 0));
		
	}

	 private JLabel createLabel(Dataset data, Color color, int width, int height, int i) {
	        return new ClusterLabel(data, color, width, height,i);
	    }
	    ...
	    class ClusterLabel extends JLabel {
	        ...
	        public ClusterLabel(Dataset data, Color color, int width, int height, int i) {
