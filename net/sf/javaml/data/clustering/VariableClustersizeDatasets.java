/**
 * VariableClustersizeDatasets.java
 *
 ...
 * different dimension.
 * 
 * All datasets contain 4 clusters
 * 
 ...
 * 
 */
public class VariableClustersizeDatasets {
    public static void main(String[] args) {
        for (int i = 25; i < 250000; i *= 2) {
            write(createNd(i), "clustersize" + i + ".data");
        }
