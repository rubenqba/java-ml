...
public class QuadraticRankingEnsemble implements IAttributeRanking {

    private IAttributeRanking[] aes;

    public QuadraticRankingEnsemble(IAttributeRanking[] aes) {
        this.aes = aes;
    }
    ...
    public void build(Dataset data) {
        ...
        for (IAttributeRanking ae : aes) {
            ...
            for (int i = 0; i < numAtt; i++)
                sum[i] += ae.getRank(i)*ae.getRank(i);
        }
        toRank(sum);
