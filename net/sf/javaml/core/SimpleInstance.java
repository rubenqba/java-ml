...
/**
 * The most simple incarnation of an instances, this basically is a wrapper
 * around a <code>double[]</code>. With additional weight and class
 * information.
 * 
 * {@jmlSource}
 * 
...
public class SimpleInstance implements Instance {
	...
	public SimpleInstance(Instance instance) {
		this(instance.toArray(), instance.weight(), instance.isClassSet(),
				instance.classValue());
	...
	private SimpleInstance(double[] values, double weight, boolean classSet,
			int classValue) {
