...
final public class DatasetTools {
    ...
    // *
    // */
    // public static Instance getNearest(Dataset data, DistanceMeasure dm,
    // Instance inst) {
    ...
    // /**
    // * Returns the k instances of the given data set that are the closest to
    // the
    // * instance that is given as a parameter.
    // *
    // * @param data
    ...
    // * @param inst
    // * the instance for which we need to find the closest
    // * @return the instances from the supplied data set that are closest to
    // the
    // * supplied instance
    // *
    // */
    // public static List<Instance> getNearestK(Dataset data, DistanceMeasure
    // dm, Instance inst, int k) {
    ...
    // * element.
    // */
    // private static void removeFarthest(Vector<Instance> vector, Instance
    // supplied, DistanceMeasure dist) {
    ...
    // /**
    // * Calculate the standard deviation of all attributes for all instances in
    // a
    ...
    // * @return a list with all the instances that are within the specified
    // range
    // */
    // public static List<Instance> epsilonRangeQuery(Dataset data, double
    // epsilon, Instance instance, DistanceMeasure dm) {
    ...
    // * @return
    // */
    // public static Dataset[] createFolds(Dataset data, int positiveClass, int
    // numFolds) {
