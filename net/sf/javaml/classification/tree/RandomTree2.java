...
public class RandomTree2 implements Classifier {
	...
	public void buildClassifier(Dataset data) {
		...
		for (Double threshold : sortedDistances) {
			...
			double error = Math.min(leftCount[0] / count[0] + rightCount[1]
					/ count[1], rightCount[0] / count[0] + leftCount[1]
					/ count[1]);
	...
	public Map<Object, Double> distributionForInstance(Instance instance) {
		throw new UnsupportedOperationException(
				"Random trees do not provide class distribution information");
	}
